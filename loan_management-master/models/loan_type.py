...
class LoanType(models.Model):
    ...
    cuenta_diferido =  fields.Many2one('account.account', 'Diferidos Pasivo')
    cuenta_ingreso =  fields.Many2one('account.account', 'Diferidos por cobrar')
    ...
    cuenta_cartera = fields.Many2one('account.account', 'CXC Cartera Socio ', required=True)
