...
class Aportaciones(models.Model):
    _name = "saving.aportaciones"
    _order = 'fecha asc'
    _inherit = ['mail.thread']

    name = fields.Char("Número de aportación", default=lambda self: self.env['ir.sequence'].next_by_code('ahorro'), states={'draft': [('readonly', False)]})
